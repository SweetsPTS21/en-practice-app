...
final recommendationPrimaryProvider =
    FutureProvider.autoDispose.family<RecommendationCardModel?, RecommendationSurface>(
  (ref, surface) async {
...
final recommendationFeedProvider =
    FutureProvider.autoDispose.family<RecommendationFeed?, RecommendationSurface>(
  (ref, surface) async {
    final api = ref.watch(recommendationApiProvider);
