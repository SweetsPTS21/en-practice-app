...
final pushOpenRouterProvider = Provider<PushOpenRouter>((ref) {
  final learningJourneyActionService = ref.watch(learningJourneyActionServiceProvider);
  return PushOpenRouter(
    learningJourneyActionService: learningJourneyActionService,
  );
});

final pushLifecycleControllerProvider = ChangeNotifierProvider<PushLifecycleController>((ref) {
